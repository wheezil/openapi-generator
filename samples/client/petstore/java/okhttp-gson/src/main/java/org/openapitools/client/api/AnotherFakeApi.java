...
public class AnotherFakeApi {
	 ...
	 */
	public com.squareup.okhttp.Call call123testSpecialTagsCall(
			Client client,
	...
	private com.squareup.okhttp.Call call123testSpecialTagsValidateBeforeCall(
			Client client,
			final ProgressResponseBody.ProgressListener progressListener,
			final ProgressRequestBody.ProgressRequestListener progressRequestListener)
			throws ApiException {
		...
		if (client == null) {
			throw new ApiException(
					"Missing the required parameter 'client' when calling call123testSpecialTags(Async)");
		}

		com.squareup.okhttp.Call call = call123testSpecialTagsCall(client,
	...
	/**
	 * To test special tags To test special tags and operation ID starting with
	 * number
	 * 
	 * @param client
	 *            client model (required)
	...
	public ApiResponse<Client> call123testSpecialTagsWithHttpInfo(Client client)
			throws ApiException {
		com.squareup.okhttp.Call call = call123testSpecialTagsValidateBeforeCall(
				client, null, null);
	...
	/**
	 * To test special tags (asynchronously) To test special tags and operation
	 ...
	 *             body object
	 */
	public com.squareup.okhttp.Call call123testSpecialTagsAsync(Client client,
