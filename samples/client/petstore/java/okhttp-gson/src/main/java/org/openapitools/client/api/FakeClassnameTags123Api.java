...
public class FakeClassnameTags123Api {
	 ...
	 */
	public com.squareup.okhttp.Call testClassnameCall(
			Client client,
	...
	private com.squareup.okhttp.Call testClassnameValidateBeforeCall(
			Client client,
			final ProgressResponseBody.ProgressListener progressListener,
			final ProgressRequestBody.ProgressRequestListener progressRequestListener)
			throws ApiException {
		...
		if (client == null) {
			throw new ApiException(
					"Missing the required parameter 'client' when calling testClassname(Async)");
		}

		com.squareup.okhttp.Call call = testClassnameCall(client,
	...
	public ApiResponse<Client> testClassnameWithHttpInfo(Client client)
			throws ApiException {
		com.squareup.okhttp.Call call = testClassnameValidateBeforeCall(client,
				null, null);
	...
	/**
	 * To test class name in snake case (asynchronously) To test class name in
	 * snake case
	 * 
	 * @param client
	 *            client model (required)
	 ...
	 *             body object
	 */
	public com.squareup.okhttp.Call testClassnameAsync(Client client,
