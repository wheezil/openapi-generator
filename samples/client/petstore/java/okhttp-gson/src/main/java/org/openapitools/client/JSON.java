...
public class JSON {
				...
				.registerTypeSelector(Animal.class, new TypeSelector() {
					...
					public Class getClassForElement(JsonElement readElement) {
						...
						classByDiscriminatorValue.put(
								"Dog".toUpperCase(Locale.ROOT), Dog.class);
						classByDiscriminatorValue.put(
								"Cat".toUpperCase(Locale.ROOT), Cat.class);
						classByDiscriminatorValue.put(
								"Animal".toUpperCase(Locale.ROOT), Animal.class);
	...
	private static String getDiscriminatorValue(JsonElement readElement,
		...
		JsonElement element = readElement.getAsJsonObject().get(
				discriminatorField);
		if (null == element) {
			...
			switch (in.peek()) {
				...
				default :
					...
					try {
						...
						return new java.sql.Date(ISO8601Utils.parse(date,
